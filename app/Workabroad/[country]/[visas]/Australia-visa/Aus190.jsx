    ...
    <div className="p-6 ">
      <div className="max-w-4xl mx-auto   ">
        ...
        <p className="mb-4" style={{ fontFamily: "Times New Roman" }}>
          ...
          <span className="text-orange-500"> VJC Overseas</span>, we specialize in helping individuals navigate the complexities of
          Australian immigration, making your journey smoother and more straightforward. Learn everything you need to
          know about the Skilled Nominated Visa Subclass 190, from eligibility criteria to lifestyle, salary structure,
        ...
        <p className="mb-4" style={{ fontFamily: "Times New Roman" }}>
          ...
          benefits that come with permanent residency, including healthcare, social security, and the ability to apply
          for Australian citizenship. The visa is designed for individuals who have the skills and qualifications needed
        ...
        <ul className="list-disc ml-6 mb-4" style={{ fontFamily: "Times New Roman" }}>
          ...
          <li>Health Benefits: Access to Medicare, Australia’s public healthcare system, ensuring high-quality medical care.</li>
        ...
        <ul className="list-disc ml-6 mb-4" style={{ fontFamily: "Times New Roman" }}>
          ...
          <li>Points Test: You must score at least 65 points on the points-based system, which considers factors like age, English proficiency, work experience, and education.</li>
...
export default AustraliaVisa190;
