...
export default function GermanyJobseekerVisa() {
  return (
    ...
    >
      <h1
        style={{ fontSize: "32px", marginBottom: "30px", fontWeight: "bold", textAlign: "center" }}
      >
      ...
      <p style={{ marginBottom: "25px" }}>
        ...
        <span style={{ color: "orange", fontWeight: "bold" }}>VJC Overseas</span>, we specialize in guiding you through every step of the application process, helping you unlock a world of career opportunities in Germany.
      </p>

      <h2 style={{ fontSize: "26px", marginTop: "40px", marginBottom: "15px" }}>What is the Germany Jobseeker Visa?</h2>
      ...
      <h2 style={{ fontSize: "26px", marginTop: "40px", marginBottom: "15px" }}>Who Can Apply for the Germany Jobseeker Visa?</h2>
      ...
      <h2 style={{ fontSize: "26px", marginTop: "40px", marginBottom: "15px" }}>Living Expenses and Lifestyle in Germany</h2>
      <ul style={{ marginBottom: "25px", paddingLeft: "20px" }}>
      ...
      <h2 style={{ fontSize: "26px", marginTop: "40px", marginBottom: "15px" }}>Processing Time for the Germany Jobseeker Visa</h2>
      <p style={{ marginBottom: "20px" }}>
      ...
      <h2 style={{ fontSize: "26px", marginTop: "40px", marginBottom: "15px" }}>Visa Fees</h2>
      <p style={{ marginBottom: "20px" }}>
      ...
      <h2 style={{ fontSize: "26px", marginTop: "40px", marginBottom: "15px" }}>How <span style={{ color: "orange", fontWeight: "bold" }}>VJC Overseas</span> Can Help You</h2>
      <ul style={{ marginBottom: "25px", paddingLeft: "20px" }}>
      ...
      <h2 style={{ fontSize: "26px", marginTop: "40px", marginBottom: "15px" }}>Conclusion</h2>
      <p style={{ marginBottom: "20px" }}>
      ...
      <p style={{ marginBottom: "30px" }}>
        Start your journey today with <span style={{ color: "orange", fontWeight: "bold" }}>VJC Overseas</span>—we are committed to helping you succeed in your career and make Germany your new home.
      </p>

      <h3 style={{ fontSize: "22px", fontWeight: "bold", marginBottom: "15px" }}>
        Contact <span style={{ color: "orange", fontWeight: "bold" }}>VJC Overseas</span> Today
      </h3>
      <p>
