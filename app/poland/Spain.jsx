    ...
    <>
      ...
      <div style={{ fontFamily: "Times New Roman, Times, serif", padding: "20px" ,fontSize: "20px"}}>
        <h1 className="text-3xl font-bold mb-4">
          Study in Spain – <span style={{ color: "orange" }}>VJC Overseas</span>: Your Gateway to World-Class Education
        </h1>
        <p>
          Are you considering studying abroad? Spain is an incredible destination for international students seeking a high-quality education in a vibrant, culturally rich environment. <span style={{ color: "orange" }}>VJC Overseas</span> makes it easy for you to discover the amazing academic opportunities available in Spain.
        </p>
        
        <h2>Why Study in Spain? Top Benefits of Studying Abroad in Spain</h2>
        <ul>
        ...
        <h2>Understanding the Fees in Spanish Universities</h2>
        <ul>
        ...
        <h2>Top Universities in Spain for International Students</h2>
        <ul>
        ...
        <h2>Study in Spain with <span style={{ color: "orange" }}>VJC Overseas</span></h2>
        <p>
          At <span style={{ color: "orange" }}>VJC Overseas</span>, we provide personalized counseling and expert guidance to help you navigate your study abroad journey in Spain. Our team will assist in selecting the best university, applying for scholarships, and securing your student visa.
        </p>
        
        <h2>Why Choose <span style={{ color: "orange" }}>VJC Overseas</span>?</h2>
        <ul>
        ...
        <p>
          If you’re ready to study in Spain, <span style={{ color: "orange" }}>VJC Overseas</span> is here to make your dream a reality. Contact us today to get started!
        </p>
      </div>
    </>
  );
