...
const StudyInMalaysia = () => {
  return (
    <div className="text-[Times New Roman] p-6 md:p-10 font-serif text-lg leading-relaxed">
      <h1 className="text-3xl md:text-4xl font-bold mb-6">
        <span className="text-orange-500">VJC Overseas</span>: Study in Malaysia – Affordable Education, Top Universities, and Global Opportunities
      </h1>
      
      <p>Welcome to <span className="text-orange-500">VJC Overseas</span>, your gateway to pursuing higher education in Malaysia...</p>
      
      <h2 className="text-2xl font-semibold mt-6">Why Choose to Study in Malaysia?</h2>
      
      <h3 className="text-xl font-semibold mt-4">1. Top-Ranked Universities and Colleges</h3>
      ...
      <h3 className="text-xl font-semibold mt-4">2. Affordable Tuition Fees</h3>
      <ul className="list-disc pl-6">
      ...
      <h3 className="text-xl font-semibold mt-4">3. High-Quality Education with International Recognition</h3>
      <p>Many universities in Malaysia offer internationally recognized degrees...</p>

      <h2 className="text-2xl font-semibold mt-6">Top Courses to Study in Malaysia</h2>
      <ul className="list-disc pl-6">
      ...
      <h2 className="text-2xl font-semibold mt-6">Cost of Living in Malaysia</h2>
      <p>Living expenses range from MYR 1,200 to MYR 2,500 per month...</p>
      
      <h2 className="text-2xl font-semibold mt-6">Benefits of Studying in Malaysia with <span className="text-orange-500">VJC Overseas</span></h2>
      <ul className="list-disc pl-6">
      ...
      <h2 className="text-2xl font-semibold mt-6">Start Your Journey to Study in Malaysia with <span className="text-orange-500">VJC Overseas</span></h2>
      <p>Contact us today to begin your exciting and enriching study experience in Malaysia...</p>
    </div>
  );
};
