...
const visaData = [
  { name: "IELTS Training/Couching", path: "/coaching/ielts-training-couching", image: "/1.jpg" },
  { name: "PTE Training/Couching", path: "/coaching/pte-training-couching" },
  { name: "GRE Training/Couching", path: "/coaching/gre-training-couching" },
  { name: "GMAT Training/Couching", path: "/coaching/gmat-training-couching" },
  { name: "TOEFL Training/Couching", path: "/coaching/toefl-training-couching" },
  { name: "DUOLINGO Training/Couching", path: "/coaching/duolingo-training-couching" },
