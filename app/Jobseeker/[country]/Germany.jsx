...
const GermanyJobseekerVisa = () => {
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <h2 className="text-2xl font-bold mt-6" style={{ fontFamily: 'Times New Roman' }}>What is the Germany Jobseeker Visa?</h2>
      ...
      <h2 className="text-2xl font-bold mt-6" style={{ fontFamily: 'Times New Roman' }}>Who Can Apply for the Germany Jobseeker Visa?</h2>
      ...
      <h2 className="text-2xl font-bold mt-6" style={{ fontFamily: 'Times New Roman' }}>Living Expenses and Lifestyle in Germany</h2>
      <ul className="list-disc ml-6 mt-2 text-lg" style={{ fontFamily: 'Times New Roman' }}>
      ...
      <h2 className="text-2xl font-bold mt-6" style={{ fontFamily: 'Times New Roman' }}>Processing Time for the Germany Jobseeker Visa</h2>
      <p className="mt-2 text-lg" style={{ fontFamily: 'Times New Roman' }}>
      ...
      <h2 className="text-2xl font-bold mt-6" style={{ fontFamily: 'Times New Roman' }}>Visa Fees</h2>
      <p className="mt-2 text-lg" style={{ fontFamily: 'Times New Roman' }}>
      ...
      <h2 className="text-2xl font-bold mt-6" style={{ fontFamily: 'Times New Roman' }}>How <span className="text-orange-500">VJC Overseas</span> Can Help You</h2>
      <ul className="list-disc ml-6 mt-2 text-lg" style={{ fontFamily: 'Times New Roman' }}>
      ...
      <h2 className="text-2xl font-bold mt-6 text-center" style={{ fontFamily: 'Times New Roman' }}>
